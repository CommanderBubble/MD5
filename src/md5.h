...
//    } md5_t;
    ...
    class md5_t {
        public:
            md5_t();
            md5_t(const char *buffer, const unsigned int buf_len, void *signature);

            void process(const void *buffer, const unsigned int buf_len);
            void process(const std::string);
            void finish(void* signature);

            get_signature();
            get_string();

        private:
            void md5_process_block(const void *buffer, const unsigned int buf_len);
...
//    extern void md5_init(md5_t *md5_p);
     ...
     */
//    extern void md5_process(md5_t *md5_p, const void *buffer, const unsigned int buf_len);
     ...
     */
//    extern void md5_finish(md5_t *md5_p, void *signature);
     ...
     * signature - A 16 byte buffer that will contain the MD5 signature.
     */
//    extern void md5_buffer(const char *buffer, const unsigned int buf_len, void *signature);
